            ...
            <div className="w-full max-w-2xl items-center justify-center bg-white border border-zinc-200 shadow dark:bg-zinc-950 dark:border-zinc-700">
              <div className="p-5 m-10">
                <div>
                  ...
                  <div className="text-xl font-semibold tracking-tight text-gray-900 dark:text-blue-400 mb-2 tracking-widest">Please Connect to a Wallet</div>
        ...
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
              <img src="https://i.ibb.co/7C7fdc9/rocketteam-LOGO32.png" className="h-8" alt="RocketTeam Logo" />
